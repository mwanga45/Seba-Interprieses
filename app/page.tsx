...
const products: Product[] = [
  {
    ...
    description:
      "Reliable pumping solutions for farms, boreholes, tanks, and irrigation systems.",
    image:
  ...
  },
  {
    ...
    category: "Agricultural",
    description:
      "Heavy-duty performance where dependable water movement matters most.",
    image:
      "https://images.unsplash.com/photo-1592982537447-6f7a4d5b2e5e?auto=format&fit=crop&w=900&q=85",
    tag: "Farm ready",
  },
  {
    name: "PVC & HDPE Pipes",
    category: "Plumbing",
    description:
      "Practical pipework for clean water, irrigation, drainage, and infrastructure.",
    image:
  ...
  },
  {
    ...
    description:
      "The everyday essentials that keep construction projects moving forward.",
    image:
  ...
  },
  {
    ...
    category: "Electrical",
    description:
      "Durable power and lighting components for homes, farms, and businesses.",
    image:
  ...
  },
  {
    ...
    category: "Hardware",
    description:
      "Trusted tools, fixings, and hardware for the worksite and workshop.",
    image:
        ...
        <div className="mx-auto grid max-w-7xl items-center gap-12 px-5 lg:grid-cols-[1fr_.9fr] lg:px-8">
          <div className="animate-in fade-in slide-in-from-bottom-4 duration-700">
            ...
            <div className="mt-12 flex gap-8 border-t border-secondary-foreground/15 pt-6">
              ...
              <div>
                <b className="font-mono text-2xl">6</b>
                <p className="text-xs text-secondary-foreground/60">
                  Core categories
                </p>
              </div>
